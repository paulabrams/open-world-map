// dragonisles.js — "Dragon Isles" parchment map style for Open World Map viewer
// Based on the Dragon Isles world-map source art (dragon_isles_simple.png).

window.MapStyles = window.MapStyles || {};

window.MapStyles.dragonisles = {
  name: "Dragon Isles",
