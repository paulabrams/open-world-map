...
| wilderland   | 7     | wl-24          | All four mountain-focus aspects addressed (sharper apex, cross-hex flow, dense hatching, ridge-line character). Paused for user rescoring. |
