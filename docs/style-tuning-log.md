...
| wilderland   | 7     | wl-22          | Sharper peaks + cross-hex ridge flow + double-line rivers + dense forests + BC routing. Mountains now read as continuous range; ready for user review. |
