...
Use Playwright to open each style in the unified viewer (`index.html`), wait for the map to render, extract `document.querySelector('#map').outerHTML`, and write to disk:

- `http://localhost:8787/index.html?map=$ARGUMENTS&style=classic&grid=square` → `maps/$ARGUMENTS/$ARGUMENTS-grid.svg`
- `http://localhost:8787/index.html?map=$ARGUMENTS&style=classic&grid=hex` → `maps/$ARGUMENTS/$ARGUMENTS-hex.svg`
- `http://localhost:8787/index.html?map=$ARGUMENTS&style=treasuremap&grid=none` → `maps/$ARGUMENTS/$ARGUMENTS-treasuremap.svg`
- `http://localhost:8787/index.html?map=$ARGUMENTS&style=wilderland&grid=none` → `maps/$ARGUMENTS/$ARGUMENTS-wilderland.svg`
- `http://localhost:8787/index.html?map=$ARGUMENTS&style=world&grid=none` → `maps/$ARGUMENTS/$ARGUMENTS-world.svg`
...
http://localhost:8787/index.html?map=$ARGUMENTS
